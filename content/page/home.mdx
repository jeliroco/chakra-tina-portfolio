...
blocks:
  ...
  - content: >
      ...
      could about software development, with a focus on game development. In the
      process, I earned myself an Bachelor of Computer Science (with a
      specialization in software/game design) as well as a Master's of Science
      (with a focus on exergaming). Since graduation I have tried to learn as
      much as I can about development of all kinds. Most recently I have been
      investing a ton of energy into web development using modern JS frameworks
      and tooling (which incidentally led to the site you're looking at now).
